...
!(function(e, t) {
    ...
    v = {
      parse: function(e, t) {
        ...
        if (
          ...
          t.worker && v.WORKERS_SUPPORTED)
        ) {
          var n = (function() {
            if (!v.WORKERS_SUPPORTED) return !1;
            if (!a && null === v.SCRIPT_PATH)
              throw new Error(
      ...
      unparse: function(e, t) {
        ...
        !(function() {
          ...
          "string" == typeof t.delimiter &&
            ...
            -1 === v.BAD_DELIMITERS.indexOf(t.delimiter) &&
            (d = t.delimiter);
  ...
  if (
    ...
    (v.BYTE_ORDER_MARK = "\ufeff"),
    (v.BAD_DELIMITERS = ["\r", "\n", '"', v.BYTE_ORDER_MARK]),
    (v.WORKERS_SUPPORTED = !r && !!f.Worker),
    (v.SCRIPT_PATH = null),
    ...
    (v.FileStreamer = p),
    (v.StringStreamer = _),
    (v.ReadableStreamStreamer = m),
    (v.DuplexStreamStreamer = g),
    f.jQuery)
  ) {
    var d = f.jQuery;
            ...
            if ("object" == typeof s) {
              if ("abort" === s.action)
                return (
                  ...
                  (i = r.inputElem),
                  (n = s.reason),
                  void (M(o.error) && o.error({ name: e }, t, i, n))
                );
    ...
    (this._handle = null),
      ...
      (this.parseChunk = function(e, t) {
        ...
        if (!this._handle.paused() && !this._handle.aborted()) {
          ...
          if (o)
            f.postMessage({ results: r, workerId: v.WORKER_ID, finished: a });
      ...
      (this._sendError = function(e) {
        M(this._config.error)
          ...
          : o &&
            this._config.error &&
            f.postMessage({ workerId: v.WORKER_ID, error: e, finished: !1 });
      });
  }
  function l(e) {
    var n;
      ...
      (this._readChunk = function() {
        if (this._finished) this._chunkLoaded();
          ...
          if (
            ...
            r ||
              ((n.onload = E(this._chunkLoaded, this)),
              (n.onerror = E(this._chunkError, this))),
  ...
  function p(e) {
    ...
    (this.stream = function(e) {
      (this._input = e),
        ...
        s
          ? (((n = new FileReader()).onload = E(this._chunkLoaded, this)),
            (n.onerror = E(this._chunkError, this)))
  ...
  function g(e) {
    ...
    (this._onCsvData = function(e) {
      ...
      (i.step = E(this._onCsvData, this)),
      (i.complete = E(this._onCsvComplete, this)),
      c.call(this, i),
      (this._nextChunk = function() {
        r && 1 === s.length && (this._finished = !0),
          s.length ? s.shift()() : (n = !0);
      }),
      (this._addToParseQueue = function(e, t) {
        s.push(
          E(function() {
            if (
              (this.parseChunk(
                "string" == typeof e ? e : e.toString(i.encoding)
              ),
              M(t))
            )
              return t();
  ...
  function i(m) {
    ...
    if (M(m.step)) {
      ...
      m.step = function(e) {
        if (((d = e), p())) l();
          ...
          (i += e.data.length),
            m.preview && i > m.preview ? a.abort() : c(d, t);
        }
      };
    }
    function l() {
        ...
        (function() {
          ...
          for (var e = 0; e < d.data.length; e++) {
            ...
            for (t = 0; t < d.data[e].length; t++) {
              var n = t,
                r = d.data[e][t];
              m.header && (n = t >= f.length ? "__parsed_extra" : f[t]),
                m.transform && (r = m.transform(r, n)),
                (r = _(n, r)),
                "__parsed_extra" === n
                  ? ((i[n] = i[n] || []), i[n].push(r))
                  : (i[n] = r);
    ...
    function g(e, t, i, n) {
      d.errors.push({ type: e, code: t, message: i, row: n });
    }
    (this.parse = function(e, t, i) {
      if (
        (m.newline ||
          (m.newline = (function(e) {
        ...
        M(m.delimiter) &&
          ((m.delimiter = m.delimiter(e)), (d.meta.delimiter = m.delimiter));
      else {
        var n = (function(e, t, i, n) {
          for (
            ...
            for (
              ...
              if (i && 1 === l.data[p].length && 0 === l.data[p][0].length) c++;
              else {
            ...
            0 < l.data.length && (d /= l.data.length - c),
              (void 0 === s || f < s) && 1.99 < d && ((s = f), (r = u));
          }
          return { successful: !!(m.delimiter = r), bestDelimiter: r };
        })(e, m.newline, m.skipEmptyLines, m.comments);
        n.successful
          ? (m.delimiter = n.bestDelimiter)
          : ((o = !0), (m.delimiter = v.DefaultDelimiter)),
          (d.meta.delimiter = m.delimiter);
      }
      var r = w(m);
      return (
        m.preview && m.header && r.preview++,
        (s = e),
        (a = new k(r)),
        (d = a.parse(s, t, i)),
        l(),
  ...
  function k(e) {
    ...
    if (
      (void 0 !== e.escapeChar && (A = e.escapeChar),
      ("string" != typeof x || -1 < v.BAD_DELIMITERS.indexOf(x)) && (x = ","),
      O === x)
    )
      throw "Comment character same as delimiter";
    !0 === O
      ? (O = "#")
      : ("string" != typeof O || -1 < v.BAD_DELIMITERS.indexOf(O)) && (O = !1),
      "\n" !== T && "\r" !== T && "\r\n" !== T && (T = "\n");
    var L = 0,
      F = !1;
    (this.parse = function(n, t, i) {
      ...
      if (P || (!1 !== P && -1 === n.indexOf(S))) {
        for (var c = n.split(T), l = 0; l < c.length; l++) {
          if (((f = c[l]), (L += f.length), l !== c.length - 1)) L += T.length;
          else if (i) return E();
          if (!O || f.substr(0, a) !== O) {
            if (o) {
      ...
      for (
        ...
        if (n[L] !== S)
          if (O && 0 === f.length && n.substr(L, a) === O) {
            ...
            f.push(n.substring(L, _)), (L = _ + e), (_ = n.indexOf(x, L));
          else {
            if (-1 === m) break;
            if ((f.push(n.substring(L, m)), w(m + s), o && (R(), F)))
              return E();
          ...
          for (p = L, L++; ; ) {
            ...
            if (S !== A || n[p + 1] !== A) {
              if (S === A || 0 === p || n[p - 1] !== A) {
                var v = C(_);
                if (n[p + 1 + v] === x) {
                  f.push(n.substring(L, p).replace(g, S)),
                    (L = p + 1 + v + e),
                    (_ = n.indexOf(x, L)),
                    (m = n.indexOf(T, L));
                  break;
  ...
  function y(e) {
    ...
    if (t.error) i.userError(t.error, t.file);
      ...
      var r = {
        abort: function() {
          (n = !0),
            C(t.workerId, { data: [], errors: [], meta: { aborted: !0 } });
        },
        pause: b,
        resume: b
      };
      if (M(i.userStep)) {
        ...
        M(i.userChunk) && (i.userChunk(t.results, r, t.file), delete t.results);
    }
